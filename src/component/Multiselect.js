    ...
    return (
        ...
        <div className="mycard">
            ...
            <h2 style={{textAlign:"center",color:"green"}}>Survey Tiger</h2>
              ...
              <div style={{marginTop:"50px",textAlign:"center"}}>  <a class='dropdown-trigger btn' href='#' data-target='dropdown1' ref={searchModal}>Multi-Select</a></div>
              ...
              <div style={{display:"flex",marginTop:"25px"}}>
                ...
                <div style={{fontSize:"20px",border:"solid 1px grey",borderRadius:"5px",width:"83%"}}>
                <input type="text" placeholder="Type answer here" value={mqs} 
                onChange={(e)=>{setMqs(e.target.value)}}
                />
                </div>
                </div>
         ...
         >
              <i class="material-icons">delete</i>
               ...
               {all.length>=3? <><button class="btn waves-effect waves-light" type="submit" name="action"  style={{height:"100%"}}
